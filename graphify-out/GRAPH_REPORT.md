# Graph Report - futurecash-next  (2026-08-16)

## Corpus Check
- 34 files · ~38,961 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 556 nodes · 1629 edges · 31 communities (13 shown, 18 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 177 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e1838d53`
...
### Community 0 - "Wallet"
Cohesion: 0.06
Nodes (24): JSONArray, JSONObject, Guardian, Node, Store, Notifier, Stake, Node (+16 more)
...
Cohesion: 0.08
Nodes (19): android.content.Context, android.graphics.drawable.GradientDrawable, android.graphics.drawable.RippleDrawable, android.graphics.Typeface, android.widget.Button, android.widget.EditText, android.widget.TextView, Design (+11 more)
...
Cohesion: 0.06
Nodes (26): android.app.Service, android.content.BroadcastReceiver, android.content.Intent, android.os.Bundle, android.os.IBinder, androidx.annotation.NonNull, androidx.appcompat.app.AppCompatActivity, androidx.work.Worker (+18 more)
...
### Community 16 - "Cfg"
Cohesion: 0.06
Nodes (17): android.app.Activity, android.content.SharedPreferences, android.os.Handler, Audit, Mode, FRESH, NONE, PARTIAL (+9 more)

### Community 17 - "MainActivity"
Cohesion: 0.13
Nodes (16): android.view.View, android.widget.LinearLayout, BroadcastReceiver, Cfg, Guardian, Node, NodeApi, Override (+8 more)
...
- **Why does `MainActivity` connect `MainActivity` to `Cfg`, `android.content.Context`, `GuardianService`?**
